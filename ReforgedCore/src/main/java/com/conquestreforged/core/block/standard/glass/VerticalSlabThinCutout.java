    ...
    public boolean isSideInvisible(BlockState state, BlockState adjacentBlockState, Direction side) {
        if (side == Direction.UP || side == Direction.DOWN) {
            if (adjacentBlockState.getBlock() instanceof GlassBlock) {
                return true;
            } else if (adjacentBlockState.getBlock() instanceof VerticalSlabThinCutout && state.get(DIRECTION) == adjacentBlockState.get(DIRECTION)) {
                return true;
                ...
                return true;
            } else if (adjacentBlockState.getBlock() instanceof VerticalCornerThinCutout && (state.get(DIRECTION) == adjacentBlockState.get(DIRECTION) || state.get(DIRECTION) == adjacentBlockState.get(DIRECTION).rotateYCCW())) {
                return true;
            } else {
                return false;
            }
        ...
        if (side == state.get(DIRECTION)) {
            ...
            return true;
        } else if (adjacentBlockState.getBlock() instanceof VerticalSlabThinCutout && ((state.get(DIRECTION) == adjacentBlockState.get(DIRECTION) && (state.get(DIRECTION).rotateY() == side || state.get(DIRECTION).rotateYCCW() == side))
                || ((state.get(DIRECTION).rotateY() == side || state.get(DIRECTION).rotateYCCW() == side) && adjacentBlockState.get(DIRECTION) == side)
                || (state.get(DIRECTION) == adjacentBlockState.get(DIRECTION).getOpposite() && state.get(DIRECTION).getOpposite() == side))) {
            return true;
            ...
            return true;
        } else if (adjacentBlockState.getBlock() instanceof VerticalCornerThinCutout && (adjacentBlockState.get(DIRECTION) != state.get(DIRECTION).rotateYCCW() && side == state.get(DIRECTION).rotateY()
                || (adjacentBlockState.get(DIRECTION) == state.get(DIRECTION).getOpposite() || adjacentBlockState.get(DIRECTION) == state.get(DIRECTION).rotateYCCW())&& side == state.get(DIRECTION).getOpposite()
                || adjacentBlockState.get(DIRECTION) != state.get(DIRECTION).getOpposite() && side == state.get(DIRECTION).rotateYCCW())) {
            return true;
            ...
            return true;
        } else if (adjacentBlockState.getBlock() instanceof VerticalQuarterThinCutout && ((adjacentBlockState.get(DIRECTION).rotateYCCW() == side && adjacentBlockState.get(DIRECTION) == state.get(DIRECTION)) || (adjacentBlockState.get(DIRECTION) == side &&  adjacentBlockState.get(DIRECTION) == state.get(DIRECTION).rotateY()))) {
            return true;
        }
