...
public class VanillaProps {
    ...
    public static Props stone() {
        return Props.create(Blocks.STONE).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }
    ...
    public static Props bricks() {
        return Props.create(Blocks.BRICKS).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }
    ...
    public static Props sand() {
        return Props.create(Blocks.SAND).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }

    public static Props gravel() {
        return Props.create(Blocks.GRAVEL).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }
    ...
    public static Props glass() {
        return Props.create(Blocks.GLASS).group(ItemGroup.TAB_DECORATIONS);
    }

    public static Props cloth() {
        return Props.create(Blocks.WHITE_WOOL).group(ItemGroup.TAB_DECORATIONS);
    }

    public static Props plants() {
        return Props.create(Blocks.GRASS).group(ItemGroup.TAB_DECORATIONS).strength(0.0D, 0.0D);
    }

    public static Props earth() {
        return Props.create(Blocks.DIRT).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }

    // blocks movement - not sure what is desirable
    public static Props plantLike() {
        return Props.create(Material.WOOL).sound(SoundType.GRASS).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }

    public static Props ice() {
        return Props.create(Blocks.PACKED_ICE).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }

    public static Props metal() {
        return Props.create(Blocks.IRON_BLOCK).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }

    public static Props leaves() {
        return Props.create(Blocks.OAK_LEAVES).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }

    public static Props leafLike() {
        return Props.create(Blocks.GRASS).group(ItemGroup.TAB_BUILDING_BLOCKS);
    }
