...
@Assets(
        ...
        block = {
                ...
                @Model(name = "block/%s_segmental_arch_one_half_bottom", template = "block/parent_segmental_arch_one_half_bottom"),
                @Model(name = "block/%s_segmental_arch_two_half_l_bottom", template = "block/parent_segmental_arch_two_half_l_bottom"),
                @Model(name = "block/%s_segmental_arch_two_half_r_bottom", template = "block/parent_segmental_arch_two_half_r_bottom"),
                @Model(name = "block/%s_segmental_arch_three_half_l_bottom", template = "block/parent_segmental_arch_three_half_l_bottom"),
                @Model(name = "block/%s_segmental_arch_three_half_r_bottom", template = "block/parent_segmental_arch_three_half_r_bottom"),
                @Model(name = "block/%s_segmental_arch_three_top_half_bottom", template = "block/parent_segmental_arch_three_top_half_bottom"),
        }
)
