...
public class BenchParallelConnecting extends HorizontalBlock implements Waterloggable {
    ...
    public BenchParallelConnecting(Properties properties) {
        super(properties);
    ...
    private boolean attachesTo(BlockState state) {
        ...
        return block instanceof BenchParallelConnecting;
    }
}
